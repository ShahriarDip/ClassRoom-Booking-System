...
def render_sidebar_login():
    ...
    if st.session_state.logged_user is None:
        ...
        if st.sidebar.button("Logout", use_container_width=True):
            ...
            st.rerun()
''',
    "views/availability.py": '''# views/availability.py
import streamlit as st
        ...
        with st.form("booking_form", clear_on_submit=True):
            ...
            if submit_btn:
                ...
                if existing:
                    ...
                    st.rerun()
''',
    "views/cancellations.py": '''# views/cancellations.py
import streamlit as st
...
''',
    "views/teacher_view.py": '''# views/teacher_view.py
import streamlit as st
...
''',
    "views/admin_view.py": '''# views/admin_view.py
import streamlit as st
import pandas as pd
...
from src.database import init_session_state, get_upcoming_week_dates
...
from views.teacher_view import render_teacher_tab
...
if tab_teacher and logged_role == "Teacher":
    with tab_teacher:
        render_teacher_tab(week_dates_list, week_dates_dict)
...
print("Project files successfully generated!")
